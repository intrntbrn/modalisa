...
local keys = {
	...
	["f"] = ps.client_toggle_property("fullscreen", nil, true),
	["m"] = ps.client_toggle_property("maximized", nil, true),
	...
	["cf"] = ps.client_toggle_property("fullscreen", nil, true) + { desc = "fullscreen" },
	["cm"] = ps.client_toggle_property("maximize", nil, true) + { desc = "maximize" },
	["ch"] = ps.client_toggle_property("maximize_horizontally", nil, true) + { desc = "maximize horizontally" },
	["cv"] = ps.client_toggle_property("maximize_vertically", nil, true) + { desc = "maximize vertically" },
	["c "] = ps.client_toggle_property("floating") + { desc = "floating" },
	["co"] = ps.client_toggle_property("ontop") + { desc = "ontop" },
	["cy"] = ps.client_toggle_property("sticky") + { desc = "sticky" },
	["ca"] = ps.client_toggle_property("above") + { desc = "above" },
	["cb"] = ps.client_toggle_property("below") + { desc = "below" },
	["cS"] = ps.client_toggle_property("skip_taskbar") + { desc = "skip taskbar" },
	["cU"] = ps.client_toggle_property("urgent") + { desc = "urgent" },
	["cT"] = ps.client_toggle_titlebar() + { desc = "titlebar toggle" },
