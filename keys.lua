...
local keys = {
	...
	["cf"] = ps.client_toggle_property("fullscreen", nil, true),
	["cm"] = ps.client_toggle_property("maximized", nil, true),
	["ch"] = ps.client_toggle_property("maximized_horizontally", nil, true),
	["cv"] = ps.client_toggle_property("maximized_vertically", nil, true),
	["c "] = ps.client_toggle_property("floating"),
	["co"] = ps.client_toggle_property("ontop"),
	["cy"] = ps.client_toggle_property("sticky"),
	["ca"] = ps.client_toggle_property("above"),
	["cb"] = ps.client_toggle_property("below"),
	["cS"] = ps.client_toggle_property("skip_taskbar"),
	["cU"] = ps.client_toggle_property("urgent"),
