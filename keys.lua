...
local keys = {
	...
	["cf"] = ps.client_toggle_fullscreen(),
	["cm"] = ps.client_toggle_maximize(),
	["cn"] = ps.client_minimize(),
	["ch"] = ps.client_toggle_maximize_horizontally(),
	["cv"] = ps.client_toggle_maximize_vertically(),
	["cC"] = ps.client_kill(),
	["c "] = ps.client_toggle_floating(),
	["co"] = ps.client_toggle_ontop(),
	["cy"] = ps.client_toggle_sticky(),
